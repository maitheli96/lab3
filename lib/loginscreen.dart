...
import 'package:h_electriction/registration.dart';
...
String urlUpload =
    "https://hireelectrian.com/h_electrician(user)/php/dbconnect.php";
      ...
      http.post(urlLogin, body: {
        ...
        if (res.body == "success") {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => Mainscreen(email: _email)));
        } else {
          pr.dismiss();
        }
      }).catchError((err) {
